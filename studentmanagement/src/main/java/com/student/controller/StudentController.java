...
public class StudentController {
	...
	// build to delete all student details REST API
	...
	@GetMapping("/getStudentsByCourseName/{course}")
	public List<StudentDTO> getStudentsByCourseName(@PathVariable("course") String courseName) {
